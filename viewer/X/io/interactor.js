...
X.interactor = function(element) {
  ...
  this._mouseUpPosition = null; // TODO: added
...
X.interactor.prototype.onMouseUp_ = function(event) {
  ...
  if (this instanceof X.interactor2D) { 
    ...
    this._mouseUpPosition = [e._x, e._y];
...
// TODO: added
X.interactor.prototype.__defineGetter__('mouseUpPosition', function() {
