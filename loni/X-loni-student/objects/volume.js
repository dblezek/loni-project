...
X.volume.prototype.makedirty = function() {
	this._dirty = true;
	
  window.console.log("Now Dirty");
	}
...
X.volume.prototype.__defineSetter__('labelmap', function(visible) {

  // we do not want to propagate to the children here
  this._labelmap = visible;
...
X.volume.prototype.__defineGetter__('image', function() {
	...
	window.console.log("getter used");
	//debugger;
	var k;
	/*
	var oned = new Array();
...
X.volume.prototype.__defineSetter__('image', function(val){
        this._image = val;
		window.console.log("setter used");
		this.modified();
		this._dirty = true;
  window.console.log("Now Dirty from setter");
...
X.volume.prototype.__defineGetter__('labelmap', function() {
    ...
    window.console.log('getter labelmap used');
  if (!this._labelmap) {
...
goog.exportSymbol('X.volume.prototype.makedirty', X.volume.prototype.makedirty);
