...
X.renderer2D.prototype.update_ = function(object) {
	...
	//window.console.log("update used one");
  ...
  //window.console.log("first time and line 414");
  ...
  if (goog.isDefAndNotNull(labelmap)) 
	window.console.log("labelmap not null");
if (goog.isDefAndNotNull(labelmap._file))
	window.console.log("labelmap._file not null");
 if (labelmap._file._dirty)  
	window.console.log("labelmap dirty");
  ...
  */
  ...
  if (goog.isDefAndNotNull(labelmap) //&& goog.isDefAndNotNull(labelmap._file) 
	...
	//window.console.log("update used before 456");
    this.update_(labelmap);
	
	//window.console.log("update used after 456");
	//window.console.log(labelmap.image);
  ...
  window.console.log("first time and line 483");
	this._firsttime =false;
	
		//volume.labelmap.file = 'data/labelsdfa.mgz';	
  
															  // with multiple files keyword
  ...
  window.console.log('reached end');
};
